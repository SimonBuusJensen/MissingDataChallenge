...
model.load_state_dict(torch.load("/home/pabllo/summer_school_ws/src/MissingDataChallenge/weighed_model_3.ckpt"))
        ...
        if (i + 1) % validate_every_n_steps == 0:
            ...
            with torch.no_grad():
                ...
                if avg_val_loss < best_val_loss:
                    ...
                    torch.save(model.state_dict(), 'weighed_model_3.ckpt')
