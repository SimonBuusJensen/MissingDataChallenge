...
from unet_resnet_model import UNet

# Instantiate the model

# Function to verify the model's shape
def verify_model_shape(model):
    ...
    assert output.shape == torch.Size([2, 3, 360, 360]), f"Unexpected output shape: {output.shape}"
...
visualize(model,"/home/pabllo/challenge/MissingDataChallenge/unet_attention_activ_finetuned_2.ckpt", val_dataloader, "cuda")
